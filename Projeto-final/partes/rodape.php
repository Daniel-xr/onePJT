    ...
    <footer class="rodape">
        <div class="rodape__linha-1">
            <div class="container">
                <div class="rodape__coluna">
                    ...
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Facilis totam accusantium ab vero. Beatae sit nulla tempora asperiores, inventore excepturi non modi blanditiis laudantium deserunt neque doloremque dolorum mollitia. Dolor!</p>
                </div>
                <div class="rodape__coluna">
        ...
        <div class="rodape__linha-2">
            © <?php echo date('Y') ?> - Todos os direitos reservados - Darth Vader
        </div>
    </footer>
